...
export default function Section({ barstitle, direction, children, backgroundimage, title, subtitle, className, id, background, backgroundcolor, backgroundattachment, backgroundposition, backgroundsize }: Props) {
  return (
    <Container 
        id={id}
