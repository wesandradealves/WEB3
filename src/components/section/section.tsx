...
export default function Section({ children, title, subtitle, className, id, background, backgroundcolor }: Props) {
  return (
    <Container 
        id={id ?? ""}
        ...
        <div className='container relative m-auto flex flex-col pt-11 pb-11 gap-7'>
            <SectionHeader className='flex flex-col justify-center items-center text-center w-full gap-7'>
                {title && <Title className='text-center' dangerouslySetInnerHTML={{ __html: title }} />}
